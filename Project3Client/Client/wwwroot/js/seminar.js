        ...
        if (confirm('are you sure?')) {
            ...
            $.ajax({
                ...
                success: function (precenter) {
                    ...
                    result += '<img src="/img/person/' + precenter.img + '" class="img-fluid" style="width:100%">';
                ...
                success: function (performent) {
                    ...
                    if (performent.length > 0) {
                        for (var i = 0; i < performent.length; i++) {
                            ...
                            result += '<img src = "/img/performent/' + performent[i].performer[i].img + '" class="img-fluid img3" style="width:100%;" >';
                            result += '<div id="details"><h3>' + performent[i].performer[i].name + '</h3>';
                            result += '<p>Birthday: ' + convertDate(performent[i].performer[i].dob) + '</p>';
                            if (performent[i].performer[i].gender) {
                                result += '<p>Gender: Male</p>';
                            ...
                            result += '<input value="' + performent[i].performer[i].id + '" name="idPerforment" hidden>';
            ...
            success: function (performent) {
                ...
                if (performent != null) {
                    for (var i = 0; i < performent.length; i++) {
                        ...
                        result += '<img src = "/img/performent/' + performent[i].img + '" class="img-fluid img3" style="width:100%;" >';
        ...
        if (confirm('are you sure?')) {
            ...
            $.ajax({
                ...
                success: function (performent) {
                    ...
                    for (var i = 0; i < performent.length; i++) {
                        result += '<div class="col-md-3" ><div id="speaker">';
                        result += '<img src = "/img/performent/' + performent[i].idPerformentNavigation.img + '" class="img-fluid img3" style="width:100%; >';
